...
> This directory contains reusable skills / workflows for kele.
> Load the relevant skill when starting work in a domain.
...
| Self-Improvement | `self-improvement.md` | Task completion | Auto-reflect and optimize rules after every task |

## Usage

At the start of a task, tell the AI:

```
Load skills/vibe-coding.md and skills/security.md, then let's build X.
```

Or let the AI auto-detect based on task keywords.
